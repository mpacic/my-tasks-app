    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 text-gray-800">
        ...
        {authLoading ? (
          ...
          <div className="text-red-500 font-medium">Authentication failed. Please refresh to try again.</div>
        )}
      </div>
    );
  }
    ...
    <div className="flex h-screen bg-white text-gray-800 overflow-hidden font-sans">
      ...
      `}>
        ...
        <div className="p-4 border-t border-gray-200">
          ...
          <div className="mt-4 text-xs text-center text-gray-400 font-mono truncate">
